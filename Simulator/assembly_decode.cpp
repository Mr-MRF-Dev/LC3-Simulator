...
string AssemblyDecode::getMsg() { return msg; }

AssemblyDecode::AssemblyDecode() : msg("OK!") {
...
errorCode AssemblyDecode::Variable(_16_BIT* final, vector<string> vec) {
...
errorCode AssemblyDecode::NOT(_16_BIT* final, vector<string> vec) {
...
errorCode AssemblyDecode::LD(_16_BIT pc, _16_BIT* final, vector<string> vec,
                       map<string, _16_BIT>& labels) {
...
errorCode AssemblyDecode::LDI(_16_BIT pc, _16_BIT* final, vector<string> vec,
                        map<string, _16_BIT>& labels) {
...
errorCode AssemblyDecode::LDR(_16_BIT* final, vector<string> vec) {
...
errorCode AssemblyDecode::LEA(_16_BIT pc, _16_BIT* final, vector<string> vec,
                        map<string, _16_BIT>& labels) {
...
errorCode AssemblyDecode::ST(_16_BIT pc, _16_BIT* final, vector<string> vec,
                       map<string, _16_BIT>& labels) {
...
errorCode AssemblyDecode::STI(_16_BIT pc, _16_BIT* final, vector<string> vec,
                        map<string, _16_BIT>& labels) {
...
errorCode AssemblyDecode::STR(_16_BIT* final, vector<string> vec) {
...
errorCode AssemblyDecode::BR(_16_BIT pc, _16_BIT* final, vector<string> vec,
                       map<string, _16_BIT>& labels) {
...
errorCode AssemblyDecode::JMP(_16_BIT* final, vector<string> vec) {
...
errorCode AssemblyDecode::RET(_16_BIT* final, vector<string> vec) {
...
errorCode AssemblyDecode::JSR(_16_BIT pc, _16_BIT* final, vector<string> vec,
                        map<string, _16_BIT>& labels) {
...
errorCode AssemblyDecode::JSRR(_16_BIT* final, vector<string> vec) {
...
errorCode AssemblyDecode::convertNumberFormat(int* num, string str) {
...
errorCode AssemblyDecode::convertNumberFormat(_16_BIT* num, string str) {
...
errorCode AssemblyDecode::imm5Range(int num) {
...
errorCode AssemblyDecode::orgRange(int num) {
...
errorCode AssemblyDecode::PCoffestRange(int num) {
...
errorCode AssemblyDecode::offest6Range(int num) {
...
void AssemblyDecode::shiftCopy(_16_BIT* final, int num, int count) {
